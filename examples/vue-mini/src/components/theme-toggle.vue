...
<template>
  <div className="wrapper">
    <h1 :aria-label="name">Getting started with {{ name }}</h1>
    <button className="button" role="button" @click="isDarkMode = !isDarkMode">
      <span>Click to switch {{ isDarkMode ? "light" : "dark" }} mode</span>
    </button>
  </div>
</template>
